...
let slider_about = new Swiper('.slider', {
	...
	// Arrows
	navigation: {
		nextEl: '.buttons-kembang__right',
		prevEl: '.buttons-kembang__left',
	},
	/*
	breakpoints: {
		320: {
...
// if (iconMenu != null) {
// 	let delay = 500;
// 	let menuBody = document.querySelector(".header__auth");
...
if (iconMenu) {
	iconMenu.addEventListener("click", function (e) {
		authHeader.classList.toggle('_active');
		iconMenu.firstElementChild.classList.toggle('_active');
	});
}
